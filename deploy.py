...
parser.add_argument('-b', '--build', action='store_true', help='Builds the heterogeneous system integrator image, for code updates.')
parser.add_argument('-d', '--detach', action='store_true', help='Starts the containers in "detach-mode", no logs available')
