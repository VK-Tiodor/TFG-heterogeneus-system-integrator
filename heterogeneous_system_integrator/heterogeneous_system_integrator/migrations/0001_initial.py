    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execute_every_period', models.CharField(blank=True, help_text='Please use the following format: Minute[0-59] Hour[0-23] Day[1-31] Month[1-12] Week[0-6](0=Sunday). Syntax guide: Use a space to separate each field.\n            -Use a comma to separate multiple values.\n            -Use a hyphen to designate a range of values.\n            -Use an asterisk as a wildcard to include all possible values.', null=True)),
