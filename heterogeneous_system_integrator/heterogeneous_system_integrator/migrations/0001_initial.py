# Generated by Django 4.2 on 2024-04-23 13:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username_field_name', models.CharField(blank=True, help_text='Field name of the username that goes in the login request. Leave blank if auth type is not JWT or OAuth', null=True)),
                ('password_field_name', models.CharField(blank=True, help_text='Field name of the password that goes in the login request. Leave blank if auth type is not JWT or OAuth', null=True)),
                ('access_token_field_name', models.CharField(blank=True, help_text='Field name of the access token that comes in the login response. Leave blank if auth type is not {API_AUTH_TYPES[API_AUTH_TYPE_JWT]} or {API_AUTH_TYPES[API_AUTH_TYPE_OAUTH]}', null=True)),
                ('auth_endpoint', models.CharField(blank=True, null=True)),
                ('auth_in_payload', models.BooleanField(blank=True, help_text='Login data is sent in the payload of the request. By default the login information is sent in the headers of the request', null=True)),
                ('auth_type', models.CharField(blank=True, choices=[('basic', 'Basic'), ('jwt', 'JWT'), ('key', 'Api key'), ('oauth', 'OAuth')], help_text='Authentication method. Leave blank if no login is required to use the API', null=True)),
